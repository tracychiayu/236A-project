...
def plot_result(result1 = None, result2 = None, result3_1 = None, result3_2 = None):
    ...
    if result3_1 != None: 
        plt.plot(result3_1['synthetic']['label_percentage'], result3_1['synthetic']['test_accuracy(our algo)'], label='our algo', marker='x', markersize=8)
        plt.plot(result3_1['synthetic']['label_percentage'], result3_1['synthetic']['test_accuracy(random)'], label='random selection', marker='o', markersize=8)
        plt.ylim(0,1)
        plt.legend()
        ...
        plt.plot(result3_1['mnist']['label_percentage'], result3_1['mnist']['test_accuracy(our algo)'], label='our algo', marker='x', markersize=8,linewidth=2)
        plt.plot(result3_1['mnist']['label_percentage'], result3_1['mnist']['test_accuracy(random)'], label='random selection', marker='o', markersize=8, linewidth=2)
        plt.ylim(0,1)
        plt.legend()
        plt.xlabel("Label Percentage", fontsize=12) 
        plt.ylabel('Test Accuracy', fontsize=12)
